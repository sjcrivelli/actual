...
fixtures_1.test.describe('Mobile Settings', function () {
    var page;
    var navigation;
    ...
    (0, fixtures_1.test)('checks that settings page can be opened', function () { return __awaiter(void 0, void 0, void 0, function () {
        var settingsPage, downloadPromise, download, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, navigation.goToSettingsPage()];
                case 1:
                    settingsPage = _b.sent();
                    return [4 /*yield*/, (0, fixtures_1.expect)(page).toMatchThemeScreenshots()];
                case 2:
                    _b.sent();
                    downloadPromise = page.waitForEvent('download');
                    return [4 /*yield*/, settingsPage.exportData()];
                case 3:
                    _b.sent();
                ...
                case 4:
                    ...
                    return [4 /*yield*/, download.suggestedFilename()];
                case 5:
                    _a.apply(void 0, [_b.sent()]).toMatch(/^\d{4}-\d{2}-\d{2}-.*.zip$/);
                    return [4 /*yield*/, (0, fixtures_1.expect)(page).toMatchThemeScreenshots()];
                case 6:
                    _b.sent();
                    return [2 /*return*/];
