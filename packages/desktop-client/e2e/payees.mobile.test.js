...
fixtures_1.test.describe('Mobile Payees', function () {
    var page;
    var navigation;
    var payeesPage;
    ...
    fixtures_1.test.beforeEach(function (_a) { return __awaiter(void 0, [_a], void 0, function (_b) {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    _c.sent();
                    return [4 /*yield*/, navigation.goToPayeesPage()];
                case 5:
    ...
    (0, fixtures_1.test)('checks the page visuals', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, payeesPage.waitForLoadingToComplete()];
                case 1:
                    _a.sent();
                    // Check that the header is present
                    return [4 /*yield*/, (0, fixtures_1.expect)(page.getByRole('heading', { name: 'Payees' })).toBeVisible()];
                case 2:
                    // Check that the header is present
                    _a.sent();
                    // Check that the search box is present with proper placeholder
                    return [4 /*yield*/, (0, fixtures_1.expect)(payeesPage.searchBox).toBeVisible()];
                case 3:
                    // Check that the search box is present with proper placeholder
                    _a.sent();
                    return [4 /*yield*/, (0, fixtures_1.expect)(payeesPage.searchBox).toHaveAttribute('placeholder', 'Filter payees…')];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, payeesPage.getPayeeCount()];
                case 5:
                    payeeCount = _a.sent();
                    (0, fixtures_1.expect)(payeeCount).toBeGreaterThan(0);
    ...
    (0, fixtures_1.test)('filters out unrelated payees', function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    noPayeesMessage = page.getByText('No payees found.');
    ...
    (0, fixtures_1.test)('clicking on a payee opens rule creation form', function () { return __awaiter(void 0, void 0, void 0, function () {
        var payeeCount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, payeesPage.waitForLoadingToComplete()];
                ...
                case 2:
                    payeeCount = _a.sent();
                    (0, fixtures_1.expect)(payeeCount).toBeGreaterThan(0);
                    return [4 /*yield*/, payeesPage.clickPayee(0)];
                case 3:
                    _a.sent();
                    // Should navigate to rules page for creating a new rule
                    return [4 /*yield*/, (0, fixtures_1.expect)(page).toHaveURL(/\/rules/)];
                case 4:
                    // Should navigate to rules page for creating a new rule
                    _a.sent();
                    return [4 /*yield*/, (0, fixtures_1.expect)(page).toMatchThemeScreenshots()];
    ...
    (0, fixtures_1.test)('page handles empty state gracefully', function () { return __awaiter(void 0, void 0, void 0, function () {
        var emptyMessage, payees;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // Search for something that won't match to get empty state
                return [4 /*yield*/, payeesPage.searchFor('NonExistentPayee123456789')];
                case 1:
                    // Search for something that won't match to get empty state
                    _a.sent();
                ...
                case 2:
                    _a.sent();
                    emptyMessage = page.getByText('No payees found.');
                    return [4 /*yield*/, (0, fixtures_1.expect)(emptyMessage).toBeVisible()];
                case 3:
                    _a.sent();
                    payees = payeesPage.getAllPayees();
                    return [4 /*yield*/, (0, fixtures_1.expect)(payees).toHaveCount(0)];
                case 4:
                    _a.sent();
                    return [4 /*yield*/, (0, fixtures_1.expect)(page).toMatchThemeScreenshots()];
                case 5:
    ...
    (0, fixtures_1.test)('search functionality works correctly', function () { return __awaiter(void 0, void 0, void 0, function () {
        var payeeCount, allPayeeCount;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, payeesPage.waitForLoadingToComplete()];
                case 1:
                ...
                case 4:
                    _a.sent();
                    // Clear search
                    return [4 /*yield*/, payeesPage.clearSearch()];
                case 5:
                    // Clear search
                    _a.sent();
                    return [4 /*yield*/, payeesPage.getPayeeCount()];
                case 6:
                    allPayeeCount = _a.sent();
                    (0, fixtures_1.expect)(allPayeeCount).toBeGreaterThan(payeeCount);
                    return [4 /*yield*/, (0, fixtures_1.expect)(page).toMatchThemeScreenshots()];
                case 7:
                    _a.sent();
                    return [2 /*return*/];
