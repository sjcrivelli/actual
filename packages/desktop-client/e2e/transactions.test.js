...
test.describe('Transactions', () => {
    ...
    test.describe('filters transactions', () => {
        ...
        test('by category', async () => {
            ...
            await expect(accountPage.getNthTransaction(0).category).toHaveText('Clothing');
    ...
    test('creates a transfer test transaction', async () => {
        ...
        await expect(page).toMatchThemeScreenshots();
        const balanceBeforeTransaction = await accountPage.accountBalance.textContent();
        ...
        await expect(async () => {
            const balanceAfterTransaction = await accountPage.accountBalance.textContent();
