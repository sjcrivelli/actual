...
export function MobileRuleEditPage() {
    ...
    if (isLoading) {
        return (_jsx(Page, { header: _jsx(MobilePageHeader, { title: t('Loading...'), leftContent: _jsx(MobileBackButton, { onPress: handleCancel }) }), padding: 0, children: _jsx(View, { style: {
                    flex: 1,
                    backgroundColor: theme.mobilePageBackground,
                    justifyContent: 'center',
                    alignItems: 'center',
                }, children: _jsx(Text, { children: _jsx(Trans, { children: "Loading rule..." }) }) }) }));
    }
    return (_jsx(Page, { header: _jsx(MobilePageHeader, { title: pageTitle, leftContent: _jsx(MobileBackButton, { onPress: handleCancel }) }), padding: 0, children: _jsx(RuleEditor, { rule: defaultRule, onSave: handleSave, onCancel: handleCancel, onDelete: isEditing && !isLinkedToSchedule ? handleDelete : undefined, style: {
                paddingTop: 10,
                flex: 1,
                backgroundColor: theme.mobilePageBackground,
            } }) }));
