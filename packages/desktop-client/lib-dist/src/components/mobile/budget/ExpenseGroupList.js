...
import { ExpenseGroupHeader, ExpenseGroupListItem, } from './ExpenseGroupListItem';
import { moveCategoryGroup } from '@desktop-client/budget/budgetSlice';
import { useDispatch } from '@desktop-client/redux';
export function ExpenseGroupList({ categoryGroups, show3Columns, showBudgetedColumn, month, onEditCategoryGroup, onEditCategory, onBudgetAction, showHiddenCategories, isCollapsed, onToggleCollapse, }) {
    ...
    const { dragAndDropHooks } = useDragAndDrop({
        ...
        renderDragPreview: items => {
            ...
            return (_jsx(ExpenseGroupHeader, { categoryGroup: group, month: month, showBudgetedColumn: showBudgetedColumn, show3Columns: show3Columns, onEditCategoryGroup: () => { }, isCollapsed: () => true, onToggleCollapse: () => { }, isHidden: false }));
        },
        onReorder: e => {
            const [key] = e.keys;
    ...
    return (_jsx(GridList, { "aria-label": t('Expense category groups'), items: categoryGroups, dependencies: [
            month,
            onEditCategoryGroup,
            onEditCategory,
            onBudgetAction,
