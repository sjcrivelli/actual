...
function TransactionListWithPreviews() {
    ...
    const baseTransactionsQuery = useCallback(() => queries.transactions().options({ splits: 'all' }).select('*'), []);
    ...
    const transactionsToDisplay = !isSearching
        ...
        : transactions;
    return (_jsx(TransactionListWithBalances, { isLoading: isSearching ? isTransactionsLoading : isPreviewTransactionsLoading, transactions: transactionsToDisplay, balance: balanceBindings.balance, isLoadingMore: isLoadingMore, onLoadMore: loadMoreTransactions, searchPlaceholder: t('Search All Accounts'), onSearch: onSearch, onOpenTransaction: onOpenTransaction, showMakeTransfer: true }));
}
