...
function renderPayeeAutocomplete(props) {
    ...
    render(_jsx(TestProvider, { children: _jsx(AuthProvider, { children: _jsx("div", { "data-testid": "autocomplete-test", children: _jsx(PayeeAutocomplete, { ...autocompleteProps, onSelect: vi.fn(), type: "single", value: null, embedded: false }) }) }) }));
...
describe('PayeeAutocomplete.getPayeeSuggestions', () => {
    ...
    test('favorites get sorted alphabetically', async () => {
        ...
        ].map(e => e.getAttribute('data-testid'))).toStrictEqual([
            'Alice-payee-item',
            'Bob-payee-item',
    ...
    test('list with less than the maximum favorites adds common payees', async () => {
        ...
        expect(extractPayeesAndHeaderNames(screen)).toStrictEqual(expectedPayeeOrder);
    });
