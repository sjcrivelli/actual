...
export function BudgetSummary({ month }) {
    ...
    const { currentMonth, summaryCollapsed: collapsed, onBudgetAction, onToggleSummaryCollapse, } = useTrackingBudget();
                ...
                opacity: 1,
                        ...
                        ...(collapsed ? { margin: '10px 0' } : { marginTop: 16 }),
                                ...
                                top: 0,
                                    ...
                                    style: { color: theme.pageTextSubdued, margin: 1 } }) }) }), _jsx("div", { className: css({
                                textAlign: 'center',
                                marginTop: 3,
                                fontSize: 18,
                                fontWeight: 500,
                                ...
                                alignItems: 'center',
                                                ...
                                                } }) })] })] })] }), !collapsed && (_jsxs(Stack, { spacing: 2, style: {
                        alignSelf: 'center',
                        backgroundColor: theme.tableRowHeaderBackground,
                        borderRadius: 4,
                        padding: '10px 15px',
                        marginTop: 13,
                    }, children: [_jsx(IncomeTotal, {}), _jsx(ExpenseTotal, {})] })), collapsed ? (_jsx(View, { style: {
                        alignItems: 'center',
                        padding: '10px 20px',
                        justifyContent: 'space-between',
                        backgroundColor: theme.tableRowHeaderBackground,
                        borderTop: '1px solid ' + theme.tableBorder,
                    }, children: _jsx(Saved, { projected: month >= currentMonth }) })) : (_jsx(Saved, { projected: month >= currentMonth, style: { marginTop: 13, marginBottom: 20 } }))] }) }));
}
