...
const balanceTypeOptions = [
    { description: t('Payment'), key: 'Payment', format: 'totalDebts' },
    { description: t('Deposit'), key: 'Deposit', format: 'totalAssets' },
    { description: t('Net'), key: 'Net', format: 'totalTotals' },
    {
...
const sortByOptions = [
    { description: t('Ascending'), key: 'Ascending', format: 'asc' },
    { description: t('Descending'), key: 'Descending', format: 'desc' },
    { description: t('Name'), key: 'Name', format: 'name' },
    { description: t('Budget'), key: 'Budget', format: 'budget' },
];
...
export const ReportOptions = {
    ...
    intervalMap: new Map(intervalOptions.map(item => [item.key, item.name])),
    intervalFormat: new Map(intervalOptions.map(item => [item.key, item.format])),
    intervalRange: new Map(intervalOptions.map(item => [item.key, item.range])),
};
...
export const categoryLists = (categories) => {
    ...
    return [categoryList, categoryGroup.filter(group => group !== null)];
};
export const groupBySelections = (groupBy, categoryList, categoryGroup, payees, accounts) => {
    let groupByList;
    let groupByLabel;
    switch (groupBy) {
        case 'Category':
