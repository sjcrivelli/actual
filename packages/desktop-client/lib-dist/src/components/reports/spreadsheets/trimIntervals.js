...
export function determineIntervalRange(data, intervalData, trimIntervals, balanceTypeOp = 'totalTotals') {
...
export function trimIntervalDataToRange(data, startIndex, endIndex) {
...
export function trimIntervalsToRange(data, startIndex, endIndex) {
...
export function trimGroupedDataIntervals(groupedData, startIndex, endIndex) {
