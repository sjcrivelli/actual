...
export function disabledGraphList(item, newGraph, type) {
...
export function disabledLegendLabel(item, newGraph, type) {
    const graphList = modeOptions.find(d => d.description === item);
    if (!graphList) {
        return false;
    }
...
export function defaultsGraphList(item, newGraph, type) {
    const graphList = modeOptions.find(d => d.description === item);
    if (!graphList) {
        return '';
    }
