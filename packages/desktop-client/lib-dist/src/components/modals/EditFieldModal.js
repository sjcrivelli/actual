...
export function EditFieldModal({ name, onSubmit, onClose, }) {
    ...
    switch (name) {
        case 'date':
            ...
            label = t('Date');
            minWidth = 350;
            editor = ({ close }) => (_jsx(DateSelect, { value: formatDate(parseISO(today), dateFormat), dateFormat: dateFormat, embedded: true, onUpdate: () => { }, onSelect: date => {
        ...
        case 'notes':
            label = t('Notes');
            editor = ({ close }) => (_jsxs(_Fragment, { children: [_jsxs(View, { style: {
                            flexDirection: 'row',
                            marginTop: 5,
                            marginBottom: 5,
                            marginLeft: 8,
                            ...
                            justifyContent: 'center',
                                ...
                                }, children: _jsx(Trans, { children: "Prepend" }) }), _jsx(Button, { style: {
                                    padding: '5px 10px',
                                    width: '33.34%',
                                    backgroundColor: theme.menuBackground,
                                    marginRight: 5,
                                    ...
                                    noteInputRef.current?.focus();
                                }, children: _jsx(Trans, { children: "Replace" }) }), _jsx(Button, { style: {
                                    padding: '5px 10px',
                                    width: '33.33%',
                                    backgroundColor: theme.menuBackground,
                                    marginRight: 5,
                                    ...
                                    onChangeMode('append');
                                    noteInputRef.current?.focus();
                                }, children: _jsx(Trans, { children: "Append" }) })] }), _jsx(Input, { ref: noteInputRef, autoFocus: true, onEnter: value => {
        ...
        case 'amount':
            label = t('Amount');
            editor = ({ close }) => (_jsx(Input, { onEnter: value => {
                    onSelect(value);
                    close();
                }, style: inputStyle }));
            break;
    ...
    return (_jsx(Modal, { name: "edit-field", noAnimation: !isNarrowWidth, onClose: onClose, containerProps: {
            style: {
        ...
        }, children: ({ state: { close } }) => (_jsxs(_Fragment, { children: [isNarrowWidth && (_jsx(ModalHeader, { title: label, rightContent: _jsx(ModalCloseButton, { onPress: close }) })), _jsxs(View, { children: [!isNarrowWidth && (_jsx(SectionLabel, { title: label, style: {
                                alignSelf: 'center',
                                color: theme.menuAutoCompleteText,
                                marginBottom: 10,
                            } })), _jsx(View, { style: { flex: 1 }, children: editor({ close }) })] })] })) }));
}
