...
export function EnvelopeBalanceMenuModal({ categoryId, onCarryover, onTransfer, onCover, }) {
    ...
    return (_jsx(Modal, { name: "envelope-balance-menu", children: ({ state: { close } }) => (_jsxs(_Fragment, { children: [_jsx(ModalHeader, { title: _jsx(ModalTitle, { title: category.name, shrinkOnOverflow: true }), rightContent: _jsx(ModalCloseButton, { onPress: close }) }), _jsxs(View, { style: {
                        ...
                        marginBottom: 20,
                                ...
                                } })) })] }), _jsx(BalanceMenu, { categoryId: categoryId, getItemStyle: () => defaultMenuItemStyle, onCarryover: onCarryover, onTransfer: onTransfer, onCover: onCover })] })) }));
}
