...
export function listenForSyncEvent(store) {
    ...
    const unlistenSuccess = listen('sync-event', event => {
        ...
        if (event.type === 'success' || event.type === 'applied') {
            ...
            const githubIssueLink = 'https://github.com/actualbudget/actual/issues/new?assignees=&labels=bug&template=bug-report.yml&title=%5BBug%5D%3A+';
            switch (event.subtype) {
                case 'out-of-sync':
                    if (attemptedSyncRepair) {
                        notif = {
                            title: t('Your data is still out of sync'),
                            message: t('We were unable to repair your sync state, sorry! You need to reset your sync state.') +
                                ' ' +
                                learnMore,
                            sticky: true,
                            id: 'reset-sync',
                        ...
                        notif = {
                            ...
                            message: t('There was a problem syncing your data. We can try to repair your sync state to fix it.') +
                                ' ' +
                                learnMore,
                            type: 'warning',
                            sticky: true,
                ...
                case 'file-old-version':
                    ...
                    notif = {
                        ...
                        message: t('This happens rarely (if ever again). The internal syncing format ' +
                        ...
                        messageActions: {
                            makeKey: () => store.dispatch(pushModal({
                ...
                case 'file-key-mismatch':
                    ...
                    notif = {
                        ...
                        message: t('Something went wrong when registering your encryption key id. ' +
                ...
                case 'file-not-found':
                    notif = {
                        ...
                        message: t('You need to register it to take advantage ' +
                ...
                case 'file-needs-upload':
                    notif = {
                        ...
                        message: t('Something went wrong when creating this cloud file. You need ' +
                ...
                case 'file-has-new-key':
                    ...
                    notif = {
                        ...
                        message: t('You need to revert it to continue syncing. Any unsynced ' +
                ...
                case 'decrypt-failure':
                    if (event.meta.isMissingKey) {
                        notif = {
                            ...
                            message: t('Unable to encrypt your data because you are missing the key. ' +
                        ...
                        notif = {
                            message: t('Unable to encrypt your data. You have the correct ' +
                ...
                case 'invalid-schema':
                    ...
                    notif = {
                        ...
                        message: t('We couldn’t apply changes from the server. This probably means you ' +
                ...
                case 'apply-failure':
                    ...
                    notif = {
                        message: t('We couldn’t apply that change to the database. Please report this as a bug by [opening a GitHub issue]({{githubIssueLink}}).', { githubIssueLink }),
                    };
                    break;
                case 'network':
                    // Show nothing
                ...
                default:
                    ...
                    notif = {
                        message: t('We had problems syncing your changes. Please report this as a bug by [opening a GitHub issue]({{githubIssueLink}}).', { githubIssueLink }),
                    };
            }
            if (notif) {
                store.dispatch(addNotification({ notification: { type: 'error', ...notif } }));
            }
        }
    });
    return () => {
