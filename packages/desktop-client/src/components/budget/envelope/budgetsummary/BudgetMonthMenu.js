...
function BudgetMonthMenu(_a) {
    var onCopyLastMonthBudget = _a.onCopyLastMonthBudget, onSetBudgetsToZero = _a.onSetBudgetsToZero, onSetMonthsAverage = _a.onSetMonthsAverage, onCheckTemplates = _a.onCheckTemplates, onApplyBudgetTemplates = _a.onApplyBudgetTemplates, onOverwriteWithBudgetTemplates = _a.onOverwriteWithBudgetTemplates, onEndOfMonthCleanup = _a.onEndOfMonthCleanup, props = __rest(_a, ["onCopyLastMonthBudget", "onSetBudgetsToZero", "onSetMonthsAverage", "onCheckTemplates", "onApplyBudgetTemplates", "onOverwriteWithBudgetTemplates", "onEndOfMonthCleanup"]);
