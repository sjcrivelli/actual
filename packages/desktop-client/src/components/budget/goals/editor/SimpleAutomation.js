...
exports.SimpleAutomation = void 0;
...
var SimpleAutomation = function (_a) {
    var _b;
    ...
    return (<forms_1.FormField>
      ...
      <AmountInput_1.AmountInput id="amount-field" key="amount-input" value={(0, util_1.amountToInteger)((_b = template.monthly) !== null && _b !== void 0 ? _b : 0, currency.decimalPlaces)} zeroSign="+" onUpdate={function (value) {
            return dispatch((0, actions_1.updateTemplate)({
                type: 'simple',
                monthly: (0, util_1.integerToAmount)(value, currency.decimalPlaces),
            }));
        }}/>
    </forms_1.FormField>);
};
exports.SimpleAutomation = SimpleAutomation;
