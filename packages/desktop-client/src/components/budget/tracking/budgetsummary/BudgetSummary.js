...
var ExpenseTotal_1 = require("./ExpenseTotal");
var IncomeTotal_1 = require("./IncomeTotal");
var Saved_1 = require("./Saved");
var TrackingBudgetContext_1 = require("@desktop-client/components/budget/tracking/TrackingBudgetContext");
...
function BudgetSummary(_a) {
    var month = _a.month;
    var locale = (0, useLocale_1.useLocale)();
    var t = (0, react_i18next_1.useTranslation)().t;
    var _b = (0, TrackingBudgetContext_1.useTrackingBudget)(), currentMonth = _b.currentMonth, collapsed = _b.summaryCollapsed, onBudgetAction = _b.onBudgetAction, onToggleSummaryCollapse = _b.onToggleSummaryCollapse;
    ...
    style={{ color: theme_1.theme.pageTextSubdued, margin: 1 }}/>
            </button_1.Button>
          </view_1.View>
          ...
          <view_1.View style={{
            ...
            <view_1.View>
              <NotesButton_1.NotesButton id={"budget-".concat(month)} width={15} height={15} tooltipPosition="bottom right" defaultColor={theme_1.theme.pageTextLight}/>
            </view_1.View>
            <view_1.View style={{ userSelect: 'none' }}>
        ...
        {!collapsed && (<stack_1.Stack spacing={2} style={{
                alignSelf: 'center',
            ...
            <IncomeTotal_1.IncomeTotal />
            <ExpenseTotal_1.ExpenseTotal />
          </stack_1.Stack>)}
        ...
        {collapsed ? (<view_1.View style={{
            ...
            <Saved_1.Saved projected={month >= currentMonth}/>
          </view_1.View>) : (<Saved_1.Saved projected={month >= currentMonth} style={{ marginTop: 13, marginBottom: 20 }}/>)}
