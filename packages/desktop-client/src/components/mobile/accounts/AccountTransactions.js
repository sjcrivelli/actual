...
function AccountTransactions(_a) {
    ...
    var schedulesQuery = (0, react_1.useMemo)(function () { return (0, useSchedules_1.getSchedulesQuery)(account.id); }, [account.id]);
...
function TransactionListWithPreviews(_a) {
    ...
    var baseTransactionsQuery = (0, react_1.useCallback)(function () {
        return queries.transactions(account.id).options({ splits: 'all' }).select('*');
    }, [account.id]);
    ...
    }), transactions = _c.transactions, isTransactionsLoading = _c.isLoading, reloadTransactions = _c.reload, isLoadingMore = _c.isLoadingMore, loadMoreTransactions = _c.loadMore;
    var _d = (0, useAccountPreviewTransactions_1.useAccountPreviewTransactions)({
        accountId: account === null || account === void 0 ? void 0 : account.id,
    }), previewTransactions = _d.previewTransactions, isPreviewTransactionsLoading = _d.isLoading;
    ...
    var onRefresh = (0, react_1.useCallback)(function () {
        if (account.id) {
            dispatch((0, appSlice_1.syncAndDownload)({ accountId: account.id }));
        }
    }, [account.id, dispatch]);
    (0, react_1.useEffect)(function () {
        if (account.id) {
            dispatch((0, accountsSlice_1.markAccountRead)({ id: account.id }));
        }
    }, [account.id, dispatch]);
    (0, react_1.useEffect)(function () {
    ...
    var _e = (0, useTransactionsSearch_1.useTransactionsSearch)({
        updateQuery: setTransactionsQuery,
        resetQuery: function () { return setTransactionsQuery(baseTransactionsQuery()); },
        dateFormat: dateFormat,
    }), isSearching = _e.isSearching, onSearch = _e.search;
            ...
            dispatch((0, modalsSlice_1.pushModal)({
                modal: {
                    ...
                    options: {
                        ...
                        onPost: function (transactionId_1) {
                            var args_1 = [];
                            for (var _i = 1; _i < arguments.length; _i++) {
                                args_1[_i - 1] = arguments[_i];
                            }
                            return __awaiter(_this, __spreadArray([transactionId_1], args_1, true), void 0, function (transactionId, today) {
                                var parts;
                                ...
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, (0, fetch_1.send)('schedule/post-transaction', {
                                                    id: parts[1],
                                                    today: today,
                                                })];
                                        case 1:
    ...
    var transactionsToDisplay = !isSearching
        ...
        : transactions;
    return (<TransactionListWithBalances_1.TransactionListWithBalances isLoading={isSearching ? isTransactionsLoading : isPreviewTransactionsLoading} transactions={transactionsToDisplay} balance={balanceBindings.balance} balanceCleared={balanceBindings.cleared} balanceUncleared={balanceBindings.uncleared} isLoadingMore={isLoadingMore} onLoadMore={loadMoreTransactions} searchPlaceholder={t('Search {{accountName}}', {
            accountName: account.name,
        })} onSearch={onSearch} onOpenTransaction={onOpenTransaction} onRefresh={onRefresh}/>);
}
