...
exports.OffBudgetAccountTransactions = OffBudgetAccountTransactions;
...
function OffBudgetAccountTransactions() {
    var schedulesQuery = (0, react_1.useMemo)(function () { return (0, useSchedules_1.getSchedulesQuery)('offbudget'); }, []);
...
function TransactionListWithPreviews() {
    ...
    var baseTransactionsQuery = (0, react_1.useCallback)(function () {
        return queries.transactions('offbudget').options({ splits: 'all' }).select('*');
    }, []);
    ...
    var offBudgetAccountsFilter = (0, react_1.useCallback)(function (schedule) {
        return offBudgetAccounts.some(function (a) { return a.id === schedule._account; });
    }, [offBudgetAccounts]);
    ...
    var transactionsToDisplay = !isSearching
        ...
        : transactions;
    return (<TransactionListWithBalances_1.TransactionListWithBalances isLoading={isSearching ? isTransactionsLoading : isPreviewTransactionsLoading} transactions={transactionsToDisplay} balance={balanceBindings.balance} isLoadingMore={isLoadingMore} onLoadMore={loadMoreTransactions} searchPlaceholder={t('Search Off Budget Accounts')} onSearch={onSearch} onOpenTransaction={onOpenTransaction} showMakeTransfer={true}/>);
}
