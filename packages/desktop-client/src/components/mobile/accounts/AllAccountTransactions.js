...
exports.AllAccountTransactions = AllAccountTransactions;
...
function AllAccountTransactions() {
    var schedulesQuery = (0, react_1.useMemo)(function () { return (0, useSchedules_1.getSchedulesQuery)(); }, []);
...
function TransactionListWithPreviews() {
    ...
    var baseTransactionsQuery = (0, react_1.useCallback)(function () { return queries.transactions().options({ splits: 'all' }).select('*'); }, []);
    ...
    var _c = (0, usePreviewTransactions_1.usePreviewTransactions)(), previewTransactions = _c.previewTransactions, isPreviewTransactionsLoading = _c.isLoading;
    ...
    var transactionsToDisplay = !isSearching
        ...
        : transactions;
    return (<TransactionListWithBalances_1.TransactionListWithBalances isLoading={isSearching ? isTransactionsLoading : isPreviewTransactionsLoading} transactions={transactionsToDisplay} balance={balanceBindings.balance} isLoadingMore={isLoadingMore} onLoadMore={loadMoreTransactions} searchPlaceholder={t('Search All Accounts')} onSearch={onSearch} onOpenTransaction={onOpenTransaction} showMakeTransfer={true}/>);
}
