...
exports.ImportYNAB5Modal = ImportYNAB5Modal;
// @ts-strict-ignore
...
function ImportYNAB5Modal() {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, dispatch((0, budgetfilesSlice_1.importBudget)({ filepath: res[0], type: 'ynab5' }))];
                    case 3:
                        _a.sent();
                        navigate('/budget');
                        return [3 /*break*/, 6];
    ...
    return (<Modal_1.Modal name="import-ynab5" containerProps={{ style: { width: 400 } }}>
      {function (_a) {
            var close = _a.state.close;
            return (<>
          <Modal_1.ModalHeader title={t('Import from nYNAB')} rightContent={<Modal_1.ModalCloseButton onPress={close}/>}/>
            ...
            <view_1.View style={{
              ...
              <paragraph_1.Paragraph>
                <react_i18next_1.Trans>
                  <Link_1.Link variant="external" to="https://actualbudget.org/docs/migration/nynab">
                    Read here
                  </Link_1.Link>{' '}
