...
exports.TrackingBudgetMonthMenuModal = TrackingBudgetMonthMenuModal;
// @ts-strict-ignore
...
var BudgetMonthMenu_1 = require("@desktop-client/components/budget/tracking/budgetsummary/BudgetMonthMenu");
...
function TrackingBudgetMonthMenuModal(_a) {
    ...
    return (<Modal_1.Modal name="tracking-budget-month-menu" containerProps={{
            style: { height: '50vh' },
        }}>
      {function (_a) {
