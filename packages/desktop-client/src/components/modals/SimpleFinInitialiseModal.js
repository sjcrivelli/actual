...
exports.SimpleFinInitialiseModal = void 0;
// @ts-strict-ignore
...
var SimpleFinInitialiseModal = function (_a) {
    ...
    var _e = (0, react_1.useState)(t('It is required to provide a token.')), error = _e[0], setError = _e[1];
    var onSubmit = function (close) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _a = (_b.sent()) || {}, error = _a.error, reason = _a.reason;
                    if (error) {
                        setIsValid(false);
    ...
    return (<Modal_1.Modal name="simplefin-init" containerProps={{ style: { width: 300 } }}>
      {function (_a) {
            var close = _a.state.close;
            return (<>
          <Modal_1.ModalHeader title={t('Set-up SimpleFIN')} rightContent={<Modal_1.ModalCloseButton onPress={close}/>}/>
          <view_1.View style={{ display: 'flex', gap: 10 }}>
            <text_1.Text>
              <react_i18next_1.Trans>
                ...
                <Link_1.Link variant="external" to="https://bridge.simplefin.org/" linkColor="purple">
                  SimpleFIN
                </Link_1.Link>
                .
              </react_i18next_1.Trans>
            ...
            <forms_1.FormField>
              <forms_1.FormLabel title={t('Token:')} htmlFor="token-field"/>
              <input_1.Input id="token-field" type="password" value={token} onChangeValue={function (value) {
                    setToken(value);
                    setIsValid(true);
                }}/>
            </forms_1.FormField>
          ...
          <Modal_1.ModalButtons>
            <button_1.ButtonWithLoading variant="primary" autoFocus isLoading={isLoading} onPress={function () {
                    onSubmit(close);
                }}>
...
exports.SimpleFinInitialiseModal = SimpleFinInitialiseModal;
