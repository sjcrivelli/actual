...
exports.EditUserAccess = EditUserAccess;
...
function EditUserAccess(_a) {
    var _b;
    var defaultUserAccess = _a.access, originalOnSave = _a.onSave;
    var t = (0, react_i18next_1.useTranslation)().t;
    var dispatch = (0, redux_1.useDispatch)();
    var _c = (0, react_1.useState)((_b = defaultUserAccess.userId) !== null && _b !== void 0 ? _b : ''), userId = _c[0], setUserId = _c[1];
    var _d = (0, react_1.useState)(''), error = _d[0], setSetError = _d[1];
    var _e = (0, react_1.useState)([]), availableUsers = _e[0], setAvailableUsers = _e[1];
    (0, react_1.useEffect)(function () {
        (0, fetch_1.send)('access-get-available-users', defaultUserAccess.fileId).then(function (data) {
            if ('error' in data) {
                setSetError(data.error);
            }
            else {
                setAvailableUsers(data.map(function (user) { return [
                    user.userId,
                    user.displayName
    ...
    function onSave(close) {
        return __awaiter(this, void 0, void 0, function () {
            var userAccess, error;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userAccess = __assign(__assign({}, defaultUserAccess), { userId: userId });
                        return [4 /*yield*/, (0, fetch_1.send)('access-add', userAccess)];
                    case 1:
                        error = (_a.sent()).error;
                        if (!error) {
                            originalOnSave === null || originalOnSave === void 0 ? void 0 : originalOnSave(userAccess);
                            close();
                        }
                        else {
                            if (error === 'token-expired') {
                                ...
                                setSetError((0, errors_1.getUserAccessErrors)(error));
                            }
                        }
                        return [2 /*return*/];
                }
    ...
    return (<Modal_1.Modal name="edit-access">
      {function (_a) {
            var close = _a.state.close;
            return (<>
          <Modal_1.ModalHeader title={t('User Access')} rightContent={<Modal_1.ModalCloseButton onPress={close}/>}/>
          <stack_1.Stack direction="row" style={{ marginTop: 10 }}>
            <forms_1.FormField style={{ flex: 1 }}>
              ...
              {availableUsers.length > 0 && (<view_1.View>
                  <select_1.Select options={availableUsers} onChange={function (newValue) { return setUserId(newValue); }} value={userId}/>
                  <label style={__assign(__assign({}, styles_1.styles.verySmallText), { color: theme_1.theme.pageTextLight, marginTop: 5 })}>
                    <react_i18next_1.Trans>Select a user from the directory</react_i18next_1.Trans>
                  </label>
                </view_1.View>)}
              {availableUsers.length === 0 && (<text_1.Text style={__assign(__assign({}, styles_1.styles.verySmallText), { color: theme_1.theme.pageTextLight, marginTop: 5 })}>
                  <react_i18next_1.Trans>No users available to give access</react_i18next_1.Trans>
                </text_1.Text>)}
            </forms_1.FormField>
          </stack_1.Stack>
          ...
          <stack_1.Stack direction="row" justify="flex-end" align="center" style={{ marginTop: 20 }}>
            ...
            <button_1.Button variant="primary" isDisabled={availableUsers.length === 0} onPress={function () { return onSave(close); }}>
