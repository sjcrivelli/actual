...
exports.TrackingBudgetMenuModal = TrackingBudgetMenuModal;
...
var BudgetMenu_1 = require("@desktop-client/components/budget/tracking/BudgetMenu");
...
function TrackingBudgetMenuModal(_a) {
    ...
    var budgeted = (0, TrackingBudgetComponents_1.useTrackingSheetValue)(bindings_1.trackingBudget.catBudgeted(categoryId));
    ...
    return (<Modal_1.Modal name="tracking-budget-menu">
      {function (_a) {
