...
exports.GoCardlessInitialiseModal = void 0;
// @ts-strict-ignore
...
var GoCardlessInitialiseModal = function (_a) {
    var onSuccess = _a.onSuccess;
    var t = (0, react_i18next_1.useTranslation)().t;
    var _b = (0, react_1.useState)(''), secretId = _b[0], setSecretId = _b[1];
    var _c = (0, react_1.useState)(''), secretKey = _c[0], setSecretKey = _c[1];
    ...
    var _f = (0, react_1.useState)(t('It is required to provide both the secret id and secret key.')), error = _f[0], setError = _f[1];
    var onSubmit = function (close) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 1:
                    _a = (_c.sent()) || {}, error = _a.error, reason = _a.reason;
                ...
                case 3:
                    (_b = (_c.sent()) || {}, error = _b.error, reason = _b.reason);
                    if (error) {
                        setIsLoading(false);
                        setIsValid(false);
                        setError((0, errors_1.getSecretsError)(error, reason));
    ...
    return (<Modal_1.Modal name="gocardless-init" containerProps={{ style: { width: '30vw' } }}>
      {function (_a) {
            var close = _a.state.close;
            return (<>
          <Modal_1.ModalHeader title={t('Set up GoCardless')} rightContent={<Modal_1.ModalCloseButton onPress={close}/>}/>
          <view_1.View style={{ display: 'flex', gap: 10 }}>
            ...
            <forms_1.FormField>
              <forms_1.FormLabel title={t('Secret ID:')} htmlFor="secret-id-field"/>
              <initial_focus_1.InitialFocus>
                <input_1.Input id="secret-id-field" type="password" value={secretId} onChangeValue={function (value) {
                    setSecretId(value);
                    setIsValid(true);
                }}/>
              </initial_focus_1.InitialFocus>
            ...
            <forms_1.FormField>
              <forms_1.FormLabel title={t('Secret Key:')} htmlFor="secret-key-field"/>
              <input_1.Input id="secret-key-field" type="password" value={secretKey} onChangeValue={function (value) {
                    setSecretKey(value);
                    setIsValid(true);
                }}/>
            </forms_1.FormField>
...
exports.GoCardlessInitialiseModal = GoCardlessInitialiseModal;
