...
exports.EnvelopeBalanceMenuModal = EnvelopeBalanceMenuModal;
...
var BalanceMenu_1 = require("@desktop-client/components/budget/envelope/BalanceMenu");
...
function EnvelopeBalanceMenuModal(_a) {
    var categoryId = _a.categoryId, onCarryover = _a.onCarryover, onTransfer = _a.onTransfer, onCover = _a.onCover;
    ...
    return (<Modal_1.Modal name="envelope-balance-menu">
      {function (_a) {
          ...
          <BalanceMenu_1.BalanceMenu categoryId={categoryId} getItemStyle={function () { return defaultMenuItemStyle; }} onCarryover={onCarryover} onTransfer={onTransfer} onCover={onCover}/>
        </>);
        }}
    </Modal_1.Modal>);
}
