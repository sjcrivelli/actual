...
var pagedQuery_1 = require("./pagedQuery");
function wait(n) {
...
function isCountQuery(query) {
    if (query.selectExpressions.length === 1) {
        var select_1 = query.selectExpressions[0];
        return select_1.result && select_1.result.$count === '*';
    }
    return false;
}
function select(row, selectExpressions) {
    return Object.fromEntries(selectExpressions.map(function (fieldName) { return [fieldName, row[fieldName]]; }));
}
function selectData(data, selectExpressions) {
    return data.map(function (row) { return select(row, selectExpressions); });
}
function limitOffset(data, limit, offset) {
    var start = offset != null ? offset : 0;
    var end = limit != null ? limit : data.length;
...
function runPagedQuery(query, data) {
    ...
    if (query.filterExpressions.length > 0) {
        var filter_1 = query.filterExpressions[0];
        if (filter_1.id != null) {
            return [data.find(function (row) { return row.id === filter_1.id; })];
        }
        if (filter_1.date != null) {
            var op_1 = Object.keys(filter_1.date)[0];
            return limitOffset(data
                .filter(function (row) {
                return op_1 === '$gte'
                    ? row.date >= filter_1.date[op_1]
                    : op_1 === '$lte'
                        ? row.date <= filter_1.date[op_1]
                        : op_1 === '$lt'
                            ? row.date < filter_1.date[op_1]
                ...
                .map(function (row) { return select(row, query.selectExpressions); }), query.limit, query.offset);
        }
    }
    else if (query.offset != null || query.limit != null) {
        return limitOffset(data.map(function (row) { return select(row, query.selectExpressions); }), query.limit, query.offset);
    }
...
function mockPagingServer(dataLength, _a) {
    var _this = this;
    var _b = _a === void 0 ? {} : _a, delay = _b.delay, _c = _b.eventType, eventType = _c === void 0 ? 'select' : _c;
    var data = [];
    for (var i = 0; i < dataLength; i++) {
        data.push({ id: i, date: (0, months_1.subDays)('2020-05-01', Math.floor(i / 5)) });
    }
    mockServer({
        send: function (name, args) { return __awaiter(_this, void 0, void 0, function () {
            var _a, query;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        query = args;
                        test_helpers_1.tracer.event('server-query', eventType === 'select' ? query.selectExpressions : query);
                        if (!delay) return [3 /*break*/, 3];
                        return [4 /*yield*/, wait(delay)];
                    case 2:
                        _b.sent();
...
describe('pagedQuery', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    (0, pagedQuery_1.pagedQuery)(query, { onData: function (data) { return test_helpers_1.tracer.event('data', data); } });
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    test_helpers_1.tracer.start();
                    query = (0, query_1.q)('transactions').select('*');
                    (0, pagedQuery_1.pagedQuery)(query, {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    test_helpers_1.tracer.start();
                    query = (0, query_1.q)('transactions').select('*');
                    lq = (0, pagedQuery_1.pagedQuery)(query, {
                        onData: function (data) { return test_helpers_1.tracer.event('data', data); },
                        options: { onlySync: true },
                    });
    ...
    it('pagedQuery makes requests in pages', function () { return function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var data, query, paged, p, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    data = mockPagingServer(1502);
                    test_helpers_1.tracer.start();
                    query = (0, query_1.q)('transactions').select('id');
                    paged = (0, pagedQuery_1.pagedQuery)(query, {
                        onData: function (data) { return test_helpers_1.tracer.event('data', data); },
                        onPageData: function (data) { return test_helpers_1.tracer.event('page-data', data); },
                    });
                    return [4 /*yield*/, test_helpers_1.tracer.expect('server-query', [{ result: { $count: '*' } }])];
                case 1:
                    _b.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('server-query', ['id'])];
                case 2:
                    _b.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('data', function (d) { return __awaiter(void 0, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, paged.fetchNext()];
                case 4:
                    _b.sent();
                    test_helpers_1.tracer.expectNow('server-query', ['id']);
                    test_helpers_1.tracer.expectNow('page-data', function (d) {
                        expect(d.length).toBe(500);
                        expect(d[0].id).toBe(data[500].id);
                    });
                    test_helpers_1.tracer.expectNow('data', function (d) {
    ...
    it('pagedQuery allows customizing page count', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, query;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = mockPagingServer(50);
                    test_helpers_1.tracer.start();
                    query = (0, query_1.q)('transactions').select('id');
                    (0, pagedQuery_1.pagedQuery)(query, {
                        onData: function (data) { return test_helpers_1.tracer.event('data', data); },
                ...
                case 2:
                    ...
                    return [4 /*yield*/, test_helpers_1.tracer.expect('data', selectData(data, ['id']).slice(0, 10))];
                case 3:
                    // Should only get 10 items back
                    _a.sent();
                    return [2 /*return*/];
    ...
    it('pagedQuery only runs `fetchNext` once at a time', function () { return function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var query, paged, p, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                ...
                case 2:
                    _b.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('data', function () { })];
                case 3:
                    _b.sent();
                    paged.fetchNext();
                    paged.fetchNext();
                ...
                case 6:
                    _b.sent();
                    p = Promise.race([test_helpers_1.tracer.expect('server-query'), wait(200)]);
                    _a = expect;
                    return [4 /*yield*/, p];
                case 7:
                    _a.apply(void 0, [_b.sent()]).toEqual('wait(200)');
                    done();
                    return [2 /*return*/];
            }
        });
    }); }; });
    it('pagedQuery refetches all paged data on update', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, query, paged;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = mockPagingServer(500, { delay: 200 });
                    test_helpers_1.tracer.start();
                    query = (0, query_1.q)('transactions').select('id');
                    paged = (0, pagedQuery_1.pagedQuery)(query, {
                        onData: function (data) { return test_helpers_1.tracer.event('data', data); },
                ...
                case 2:
                    _a.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('data', function (d) {
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('page-data', function (d) {
                            expect(d.length).toBe(20);
    ...
    it('pagedQuery reruns `fetchNext` if data changed underneath it', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, query, paged;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = mockPagingServer(500, { delay: 10 });
                    query = (0, query_1.q)('transactions').select('id');
                    paged = (0, pagedQuery_1.pagedQuery)(query, {
                        onData: function (data) { return test_helpers_1.tracer.event('data', data); },
                        onPageData: function (data) { return test_helpers_1.tracer.event('page-data', data); },
                ...
                case 1:
                    _a.sent();
                    test_helpers_1.tracer.start();
                    paged.fetchNext().then(function () {
                        test_helpers_1.tracer.event('page-finished');
                    });
                ...
                case 9:
                    ...
                    // has settled
                    return [4 /*yield*/, test_helpers_1.tracer.expect('page-finished')];
                case 10:
                    // Make sure the page promise is never resolved until everything
                    // has settled
                    _a.sent();
    ...
    it('pagedQuery fetches up to a specific row', function () { return __awaiter(void 0, void 0, void 0, function () {
        var data, query, paged, item;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    data = mockPagingServer(500, { delay: 10, eventType: 'all' });
                    query = (0, query_1.q)('transactions').select(['id', 'date']);
                    paged = (0, pagedQuery_1.pagedQuery)(query, {
                        onData: function (data) { return test_helpers_1.tracer.event('data', data); },
                        onPageData: function (data) { return test_helpers_1.tracer.event('page-data', data); },
                        options: { pageCount: 20 },
                    });
                    return [4 /*yield*/, paged.run()];
                case 1:
                    _a.sent();
                    test_helpers_1.tracer.start();
                    item = data.find(function (row) { return row.id === 300; });
                    paged.refetchUpToRow(item.id, { field: 'date', order: 'desc' });
                    return [4 /*yield*/, test_helpers_1.tracer.expect('server-query', expect.objectContaining({
                            selectExpressions: [{ result: { $count: '*' } }],
                        }))];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('server-query', expect.objectContaining({ filterExpressions: [{ id: 300 }] }))];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('server-query', expect.objectContaining({
                ...
                case 5:
                    _a.sent();
                    return [4 /*yield*/, test_helpers_1.tracer.expect('data', data.slice(0, data.findIndex(function (row) { return row.date < item.date; }) + 20))];
                case 6:
                    _a.sent();
