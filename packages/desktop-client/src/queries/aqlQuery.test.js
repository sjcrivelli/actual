...
describe('aqlQuery', function () {
    it('runs an AQL query', function () { return __awaiter(void 0, void 0, void 0, function () {
        var query, data;
            ...
            switch (_a.label) {
                case 0:
                    vi.spyOn(fetch, 'send').mockImplementation(function (name, args) {
                        ...
                        return Promise.reject(new Error("Unknown command: ".concat(name)));
                    });
