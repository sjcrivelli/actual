...
globalThis.Actual.isUpdateReadyForDownload =
    globalThis.Actual.isUpdateReadyForDownload || (function () { return false; });
globalThis.Actual.applyAppUpdate =
    globalThis.Actual.applyAppUpdate || (function () { return __awaiter(void 0, void 0, void 0, function () { return __generator(this, function (_a) {
        return [2 /*return*/];
    }); }); });
        ...
        (function () { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    return [4 /*yield*/, Promise.resolve().then(function () { return require('./browser-preload.browser.js'); })];
                    case 1:
                        // lazy-load the browser worker preload which registers the worker
                        _a.sent();
                        // the preload attaches a singleton `window.__actualWebSocket`
                        if (globalThis.__actualWebSocket) {
                            return [2 /*return*/, globalThis.__actualWebSocket];
                        }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (globalThis.__actualWebSocket)
                            return [2 /*return*/, globalThis.__actualWebSocket];
                        if (!globalThis.Actual.getServerSocket) return [3 /*break*/, 2];
                        return [4 /*yield*/, globalThis.Actual.getServerSocket()];
                    case 1: return [2 /*return*/, _a.sent()];
                    case 2: throw new Error('ipcConnect: no web socket available');
                }
            });
        }); });
(function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (globalThis.__actualWebSocket)
                        return [2 /*return*/, globalThis.__actualWebSocket];
                    if (!((_a = globalThis.Actual) === null || _a === void 0 ? void 0 : _a.getServerSocket)) return [3 /*break*/, 2];
                    return [4 /*yield*/, globalThis.Actual.getServerSocket()];
