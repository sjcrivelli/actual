...
var lootFs = require("../fs");
var getStorePath = function () { return (0, path_1.join)(lootFs.getDataDir(), 'global-store.json'); };
var store;
var persisted = true;
var init = function (_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.persist, persist = _c === void 0 ? true : _c;
    if (persist) {
        try {
...
function multiGet(keys) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            results = keys.map(function (key) { return [key, store[key]]; });
