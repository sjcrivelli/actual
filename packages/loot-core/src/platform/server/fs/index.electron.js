...
export const exists = filepath => new Promise(resolve => {
    fs.access(filepath, fs.constants.F_OK, err => {
        return resolve(!err);
    });
});
export const mkdir = filepath => new Promise((resolve, reject) => {
...
export const size = filepath => new Promise((resolve, reject) => {
