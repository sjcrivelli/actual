...
describe('utility functions', function () {
    test('looseParseAmount works with basic numbers', function () {
    ...
    test('looseParseAmount works with alternate formats', function () {
        expect((0, util_1.looselyParseAmount)('3,45')).toBe(3.45);
    ...
    test('looseParseAmount works with leading decimal characters', function () {
        expect((0, util_1.looselyParseAmount)('.45')).toBe(0.45);
        expect((0, util_1.looselyParseAmount)(',45')).toBe(0.45);
    });
    test('looseParseAmount works with negative numbers', function () {
        expect((0, util_1.looselyParseAmount)('-3')).toBe(-3);
        expect((0, util_1.looselyParseAmount)('-3.45')).toBe(-3.45);
        expect((0, util_1.looselyParseAmount)('-3,45')).toBe(-3.45);
    });
    test('looseParseAmount works with parentheses (negative)', function () {
        expect((0, util_1.looselyParseAmount)('(3.45)')).toBe(-3.45);
        expect((0, util_1.looselyParseAmount)('(3)')).toBe(-3);
    });
    test('looseParseAmount ignores non-numeric characters', function () {
    ...
    test('number formatting works with comma-dot format', function () {
        (0, util_1.setNumberFormat)({ format: 'comma-dot', hideFraction: false });
        var formatter = (0, util_1.getNumberFormat)().formatter;
    ...
    test('number formatting works with comma-dot-in format', function () {
    ...
    test('number formatting works with dot-comma format', function () {
    ...
    test('number formatting works with space-comma format', function () {
    ...
    test('number formatting works with apostrophe-dot format', function () {
    ...
    test('currencyToAmount works with basic numbers', function () {
    ...
    test('currencyToAmount works with varied formats', function () {
        (0, util_1.setNumberFormat)({ format: 'comma-dot', hideFraction: true });
        expect((0, util_1.currencyToAmount)('3,45')).toBe(3.45);
    ...
    test('currencyToAmount works with leading decimal characters', function () {
        expect((0, util_1.currencyToAmount)('.45')).toBe(0.45);
        expect((0, util_1.currencyToAmount)(',45')).toBe(0.45);
    });
    test('currencyToAmount works with negative numbers', function () {
        expect((0, util_1.currencyToAmount)('-3')).toBe(-3);
        expect((0, util_1.currencyToAmount)('-3.45')).toBe(-3.45);
        expect((0, util_1.currencyToAmount)('-3,45')).toBe(-3.45);
    });
    test('currencyToAmount works with non-fractional numbers', function () {
        (0, util_1.setNumberFormat)({ format: 'comma-dot', hideFraction: false });
        expect((0, util_1.currencyToAmount)('3.')).toBe(3);
        expect((0, util_1.currencyToAmount)('3,')).toBe(3);
    ...
    test('currencyToAmount works with hidden fractions', function () {
        (0, util_1.setNumberFormat)({ format: 'comma-dot', hideFraction: true });
        expect((0, util_1.currencyToAmount)('3.45')).toBe(3.45);
    ...
    test('currencyToAmount works with dot-comma', function () {
        (0, util_1.setNumberFormat)({ format: 'dot-comma', hideFraction: false });
        expect((0, util_1.currencyToAmount)('3,45')).toBe(3.45);
        expect((0, util_1.currencyToAmount)('3,456')).toBe(3.456);
        expect((0, util_1.currencyToAmount)('3,4500')).toBe(3.45);
    ...
    test('titleFirst works with all inputs', function () {
