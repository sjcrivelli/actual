...
export function splitTransaction(transactions, id, createSubtransactions) {
    return replaceTransactions(transactions, id, trans => {
        if (trans.is_parent || trans.is_child) {
            return trans;
        }
...
export function makeAsNonChildTransactions(childTransactionsToUpdate, transactions) {
