...
import { splitTransaction, updateTransaction, deleteTransaction, addSplitTransaction, makeChild, } from './transactions';
...
describe('Transactions', () => {
    test('updating a transaction works', () => {
        ...
        const { data, diff } = updateTransaction(transactions, makeTransaction({
            id: 't1',
            amount: 5000,
        }));
