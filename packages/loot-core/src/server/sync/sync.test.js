...
describe('Sync', () => {
    ...
    it('should sync multiple clients', async () => {
        ...
        await mockSyncServer.handlers['/sync/sync'](await encoder.encode('group', 'client', Timestamp.parse('1970-01-01T01:17:37.000Z-0000-0000testinguuid2'), [
            {
                dataset: 'transactions',
                row: 'foo',
                column: 'amount',
                value: 'N:3200',
                timestamp: Timestamp.parse('1970-01-02T05:17:36.789Z-0000-0000testinguuid2'),
            },
            {
                dataset: 'transactions',
                row: 'foo',
                column: 'amount',
                value: 'N:4200',
                timestamp: Timestamp.parse('1970-01-02T10:17:36.999Z-0000-0000testinguuid2'),
            },
        ]));
        await applyMessages([
