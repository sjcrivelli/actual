...
import { migrate, withMigrationsDir, getAppliedMigrations, getMigrationList, getPending, } from './migrations';
...
describe('Migrations', () => {
    test('gets the latest migrations', async () => {
        ...
        const available = await getMigrationList(__dirname + '/../../mocks/migrations');
    ...
    test('applied migrations are returned in order', async () => {
        return withMigrationsDir(__dirname + '/../../mocks/migrations', async () => {
