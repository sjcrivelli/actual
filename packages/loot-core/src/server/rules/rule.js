// @ts-strict-ignore
import { addSplitTransaction, groupTransaction, recalculateSplit, splitTransaction, ungroupTransaction, } from '../../shared/transactions';
...
function execSplitActions(actions, transaction) {
    ...
    const { data } = splitTransaction(ungroupTransaction(transaction), transaction.id);
...
export function execActions(actions, transaction) {
