...
describe('runSchedule', () => {
    ...
    it('should return correct budget when recurring schedule set', async () => {
        ...
        vi.mocked(getRuleForSchedule).mockResolvedValue(new Rule({
            id: 'test',
            stage: 'pre',
            conditionsOp: 'and',
            conditions: [
        ...
        // When
        const result = await runSchedule(template_lines, current_month, balance, remainder, last_month_balance, to_budget, errors, category);
        // Then
