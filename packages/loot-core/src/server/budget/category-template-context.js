            ...
            switch (template.type) {
                ...
                case 'schedule': {
                    if (!scheduleFlag) {
                        ...
                        const ret = await runSchedule(t, this.month, budgeted, remainder, this.fromLastMonth, toBudget, [], this.category);
    ...
    static runBy(templateContext) {
        ...
        for (let i = 0; i < byTemplates.length; i++) {
            ...
            if (numMonths > shortNumMonths && period) {
                amount = Math.round((amountToInteger(template.amount) / period) *
                ...
                amount = Math.round((amountToInteger(template.amount) / (numMonths + 1)) *
                    (shortNumMonths + 1));
            }
            else {
