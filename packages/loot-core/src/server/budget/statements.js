...
function resetCategoryGoalDefsWithNoTemplates() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.run("\n      UPDATE categories\n      SET goal_def = NULL\n      WHERE id NOT IN (SELECT n.id\n                       FROM notes n\n                       WHERE lower(note) LIKE '%".concat(template_notes_1.TEMPLATE_PREFIX, "%'\n                          OR lower(note) LIKE '%").concat(template_notes_1.GOAL_PREFIX, "%')\n        AND COALESCE(JSON_EXTRACT(template_settings, '$.source'), 'notes') <> 'ui'\n    "))];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function getActiveSchedules() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, db.all('SELECT id, rule, active, completed, posts_transaction, tombstone, name from schedules WHERE name NOT NULL AND tombstone = 0')];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
