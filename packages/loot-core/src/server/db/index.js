// @ts-strict-ignore
import { makeClock, setClock, serializeClock, deserializeClock, makeClientId, Timestamp, } from '@actual-app/crdt';
...
import { toDateRepr, accountModel, categoryModel, categoryGroupModel, payeeModel, } from '../models';
...
// different files
export async function getCategories(ids) {
...
export async function getCategoriesGrouped(ids) {
...
export async function insertCategory(category, { atEnd } = { atEnd: undefined }) {
    let sort_order;
    let id_;
