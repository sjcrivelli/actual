...
function mergeTransactions(transactions) {
    return __awaiter(this, void 0, void 0, function () {
        var txIds, _a, a, b, _b, keep, drop;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    txIds = (transactions === null || transactions === void 0 ? void 0 : transactions.map(function (x) { return x === null || x === void 0 ? void 0 : x.id; }).filter(Boolean)) || [];
                    if (txIds.length !== 2) {
                        throw new Error('Merging is only possible with 2 transactions, but found ' +
                            JSON.stringify(transactions));
                    }
                    return [4 /*yield*/, Promise.all(txIds.map(db.getTransaction))];
                case 1:
                    _a = _c.sent(), a = _a[0], b = _a[1];
                    if (!a || !b) {
                    ...
                    _b = determineKeepDrop(a, b), keep = _b.keep, drop = _b.drop;
