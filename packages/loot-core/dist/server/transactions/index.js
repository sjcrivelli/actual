...
const rules = __importStar(require("./transaction-rules"));
const transfer = __importStar(require("./transfer"));
async function idsWithChildren(ids) {
    const whereIds = (0, util_1.whereIn)(ids, 'parent_id');
...
async function getTransactionsByIds(ids) {
    ...
    return (0, util_1.incrFetch)((query, params) => db.selectWithSchema('transactions', query, params), ids, 
