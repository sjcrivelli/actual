...
const validateSessionMiddleware = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    let session;
    return __generator(this, function (_a) {
        switch (_a.label) {
...
const requestLoggerMiddleware = expressWinston.logger({
    ...
    format: (_a = winston.format).combine.apply(_a, __spreadArray(__spreadArray([], (Object.prototype.hasOwnProperty.call(process.env, 'NO_COLOR')
        ...
        winston.format.printf(function (args) {
            const timestamp = args.timestamp, level = args.level, meta = args.meta;
            const req = meta === null || meta === void 0 ? void 0 : meta.req;
            const res = meta === null || meta === void 0 ? void 0 : meta.res;
            if (req && res) {
