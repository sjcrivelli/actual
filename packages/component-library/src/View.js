...
exports.View = (0, react_1.forwardRef)((props, ref) => {
    ...
    return (<div {...restProps} ref={innerRef ?? ref} style={nativeStyle} className={(0, css_1.cx)('view', className, style && Object.keys(style).length > 0 ? (0, css_1.css)(style) : undefined)}/>);
});
