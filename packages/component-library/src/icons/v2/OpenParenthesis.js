...
var SvgOpenParenthesis = function (props) { return (<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 56.7" preserveAspectRatio="none" style={__assign({ color: 'inherit' }, props.style)}>
