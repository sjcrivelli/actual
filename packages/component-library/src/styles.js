...
exports.styles = {
    ...
    page: {
        ...
        [`@media (min-width: ${tokens_1.tokens.breakpoint_small})`]: {
            paddingTop: 36,
        },
    },
    pageContent: {
    ...
    tooltip: {
        ...
        borderRadius: 4,
        borderStyle: 'solid',
        borderColor: theme_1.theme.tooltipBorder,
        backgroundColor: theme_1.theme.tooltipBackground,
        color: theme_1.theme.tooltipText,
        overflow: 'auto',
    },
    popover: {
        border: 'none',
